        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="card shadow-sm border-0">
                <div class="card-body p-4 p-lg-5">
                    <h5 class="card-title mb-4 border-bottom pb-3">Formulir Edit Jenis Tiket</h5>
                    ...
                    <form action="{{ route('tickets.update', $ticket) }}" method="POST">
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" name="nama_tiket" id="nama_tiket" class="form-control @error('nama_tiket') is-invalid @enderror" value="{{ old('nama_tiket', $ticket->nama_tiket) }}" required>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" name="harga" id="harga" class="form-control @error('harga') is-invalid @enderror" value="{{ old('harga', $ticket->harga) }}" required>
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" name="stok" id="stok" class="form-control @error('stok') is-invalid @enderror" value="{{ old('stok', $ticket->stok) }}" required>
                            ...
                            <div class="col-12 mt-5 border-top pt-4">
                                <div class="d-flex justify-content-end gap-2">
                                    ...
                                    <button type="submit" class="btn btn-primary px-5 font-weight-bold shadow-sm">Perbarui Data Tiket</button>
                                </div>
                            </div>
                        </div>
                    </form>
